/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2a54bfd6e65a1457a12ac884f4684c73)
// Runtime types generated with workerd@1.20260721.1 2026-07-23 nodejs_compat
interface __BaseEnv_Env {
	ROOM_DIRECTORY: DurableObjectNamespace<import("./src/index").RoomDirectory>;
	ROOM_RELAY: DurableObjectNamespace<import("./src/index").RoomRelay>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RoomDirectory" | "RoomRelay";
	}
